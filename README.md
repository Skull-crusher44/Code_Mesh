...
2. **Clone the repository:**
   ```bash
   git clone https://github.com/<your-username>/Code_Mesh.git
   ```
3. **Create .env file:**
...
We welcome contributions to make Code Mesh even better! Follow the [contribution guidelines](CONTRIBUTING.md) to get started.
